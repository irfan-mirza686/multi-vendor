...
<link rel="stylesheet" href="{{asset('assets/common/css/upload_img.css')}}">
@endsection
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="profile-pic-wrapper">
                                        <div class="pic-holder">
                                            ...
                                            <?php
                                        $image = getFile('vendors',$user->image) ?? getFile('', 'user.png');
                                    ...
                                    <div class="ms-auto">
                                        <div class="col">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-outline-info px-5 radius-30"
                                                id="subscriberUpdatePassBtn" data-URL="{{route('vendor.update.password')}}" style="float: right;">Update Password</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<script src="{{asset('assets/common/js/upload_img.js')}}"></script>
