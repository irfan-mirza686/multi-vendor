<!-- Login Modal -->
<div class="modal fade" id="wholesallerLoginModal" role="dialog">
    <div class="modal-dialog modal-dialog-centered login-modal" role="document">
        <div class="modal-content">
            <div class="auth-box">
                ...
                <!-- form start -->
                <form id="form_wholesaler_login" action="{{route('wholesaler.login')}}" method="post" novalidate="novalidate">@csrf
