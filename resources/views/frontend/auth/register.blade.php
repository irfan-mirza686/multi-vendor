    ...
    <div class="auth-box">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <!-- form start -->
                <form action="{{route('register.consumer.store')}}" id="form_validate" class="validate_terms" method="POST">
                    @csrf
                    ...
                    <p class="p-social-media m-0 m-t-15">Have an account?&nbsp;<a href="javascript:void(0)" class="link"
