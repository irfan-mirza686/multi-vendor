    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                <div class="col">
                    <div class="card radius-10 border-start border-0 border-4 border-info">
                        <div class="card-body">
                            <a href="javascript:void(0);" data-url="" class="viewStockItems" id="viewNewItems"
                                data-Type="new">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary">New Mobiles</p>
                                        <h4 class="my-1 text-info">4343</h4>
                ...
                <div class="col">
                    <div class="card radius-10 border-start border-0 border-4 border-danger">
                        <div class="card-body">
                            <a href="javascript:void(0);" data-url="" class="viewStockItems" id="viewUsedItems"
                                data-Type="used">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary">Used Mobiles</p>
                                        <h4 class="my-1 text-danger">555</h4>
