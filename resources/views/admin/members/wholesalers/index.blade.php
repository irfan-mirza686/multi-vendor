...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Wholesalers</div>
            <div class="ps-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered wholesalersList-table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
...
<script src="{{asset('assets/admin/js/wholesalers/wholesalerList.js')}}"></script>
@endpush