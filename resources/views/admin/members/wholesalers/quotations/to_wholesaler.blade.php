...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">To Wholesalers</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table mb-0 table-sm ToWholesaler-quotations-table">
                        <thead class="table-light">
                            <tr>

                                <th width="2%">#</th>
                                <th width="20%">Product</th>
                                <th width="18%">To WholeSaler</th>
                                <th width="20%">Quotation</th>
                                <th width="10%">Date</th>
                                <th width="10%">From Vendor</th>
...
@push("custom-script")
<script src="{{asset('assets/admin/js/wholesalers/quotations.js')}}"></script>
<script>
		$(function () {
