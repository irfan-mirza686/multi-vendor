...
@section('title', '| Subscriber Registration Form')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <h6 class="mb-0 text-uppercase">Subscriber Form</h6>
                <hr/>
                <div class="card border-top border-0 border-4 border-info">
                    ...
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            <form action="{{route('admin.subscriber.store')}}" method="post">@csrf
                                <div class="card-title d-flex align-items-center">
                                    <div><i class="bx bxs-user me-1 font-22 text-info"></i>
                                    </div>
                                    <h5 class="mb-0 text-info">Subscriber Registration</h5>
                                </div>
                                <hr/>
                                <div class="row mb-3">
                                    <label for="inputEnterYourName" class="col-sm-3 col-form-label">Full Name <font style="color: red;">*</font></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputEnterYourName" placeholder="Full Name" name="name">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEnterYourName" class="col-sm-3 col-form-label">Company Name <font style="color: red;">*</font></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputEnterYourName" placeholder="Company Name" name="company_name">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Email Address <font style="color: red;">*</font></label>
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="inputEmailAddress2" placeholder="Email Address" name="email">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Phone No <font style="color: red;">*</font></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputPhoneNo2" placeholder="Phone No" name="mobile">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="inputChoosePassword2" class="col-sm-3 col-form-label">Choose Password <font style="color: red;">*</font></label>
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="inputChoosePassword2" placeholder="Choose Password" name="password">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="result form-control date" name="start_date" type="text" id="date" placeholder="Date Picker...">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="startDate" class="col-sm-3 col-form-label">End Date <font style="color: red;">*</font></label>
                                    <div class="col-sm-9">
                                        <input class="result form-control date" type="text" name="end_date" id="date" placeholder="Date Picker...">
                                    </div>
                                </div>
