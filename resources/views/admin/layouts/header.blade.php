    ...
    <nav class="navbar navbar-expand">
      ...
      <div class="top-menu ms-auto">
              ...
              <div class="row row-cols-3 g-3 p-3">
                <div class="col text-center">
                  <a href="{{route('admin.products')}}">
                    <div class="app-box mx-auto bg-gradient-cosmic text-white"><i class="fadeIn animated bx bx-package"></i>
                    </div>
                ...
                <div class="col text-center">
                  <a href="{{route('admin.subscribers')}}">
                    <div class="app-box mx-auto bg-gradient-lush text-white"><i class='bx bx-bookmark-heart'></i>
                    </div>
                    <div class="app-title">Subscribers</div>
                  </a>
                </div>
                <div class="col text-center">
                  <a href="{{route('admin.trashed.products')}}">
                    <div class="app-box mx-auto bg-gradient-burning text-white"><i class="fadeIn animated bx bx-trash"></i>
                    </div>
                    <div class="app-title">Trashed</div>
                  </a>
                </div>
        ...
        if (Auth::guard('admin')->user()->image) { 
          ...
          $image = asset('uploads/profile.jpg');
