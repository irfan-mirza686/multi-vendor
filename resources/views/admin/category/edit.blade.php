					...
					<div class="card-header">
						<div class="ms-auto">
							<div class="col">
								...
								<a href="{{route('admin.product.categories')}}" class="btn btn-primary px-5 rounded-0" style="float: right;"><i class="fadeIn animated bx bx-arrow-back"></i> Back</a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="p-4 border rounded">
							<form class="row g-3 needs-validations" action="{{route('admin.product.category.update',$editData['id'])}}" method="post" novalidate>@csrf
								<div>
