<div class="modal fade" id="countryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="addCountryForm" action="{{route('admin.country.store')}}">
                <div class="modal-body">
                
                    <label for="exampleDataList" class="form-label">Country Name</label>
                    <input class="form-control form-control-sm mb-3" name="name" type="text" placeholder="Enter Country Name"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-block rounded-0" style="width:80% !important; margin: auto; background-color: black; color: white;"><span id="spinner" class="" role="status" aria-hidden="true"></span>&nbsp;&nbsp;<span class="saveCountryBtn">Create Country</span></button>
                </div>
            </form>
