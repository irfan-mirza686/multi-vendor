...
<div class="page-wrapper">
	<div class="page-content">
		...
		<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
			<div class="breadcrumb-title pe-3">Package Type</div>
			<div class="ps-3">
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="p-4 border rounded">
							<form class="row g-3 needs-validations" action="{{route('admin.package.type.store')}}" method="post" novalidate>@csrf
								<div>
