            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                <div class="col mx-auto">
                    <div class="mb-4 text-center">
                        <img src="@if ($general->logo) {{ getFile('logo', $general->logo) }} @else {{asset('assets/uploads/no-image.png')}} @endif" width="180" alt="" />
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('wholesaler.login') }}">
            @csrf
                            <div class="border p-4 rounded">
                                <div class="text-center">
                                    <h3 class="">WholeSaler Panel Login</h3>
